...
trained_model = True
num_labels = 2
class_label = {0: 'US_2018', 1: 'US_2019'}
num_layers = 12
num_heads = 12
...
# mydata=pd.read_csv("./data-generation/data/modified/mydata.csv")
# from torch.utils.data import Dataset
# MyDataset = MyData(mydata)
# dataset_test = MyDataset
# len_dataset = len(MyDataset)
dataset_test = load_dataset('./data-generation/data/modified', split='train[:3%]')
...
if not trained_model:
	...
	# Load data
	dataset_vali = load_dataset('./data-generation/data/modified', split='train[3%:6%]')

	dataset_train = load_dataset('./data-generation/data/modified', split='train[6%:]')
