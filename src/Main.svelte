<script>
  ...
  const attentionDataDir = 'PUBLIC_URL/data/twitter-attention-data/';
  const dependencyDataFilepath = 'PUBLIC_URL/data/twitter-dependencies.json';
  const syntacticHeadDataFilepath = 'PUBLIC_URL/data/twitter-sorted-syntactic-heads.json';
  const semanticHeadDataFilepath = 'PUBLIC_URL/data/twitter-sorted-saliency-heads.json';
  const importantHeadDataFilepath = 'PUBLIC_URL/data/twitter-sorted-confidence-heads.json';
  const saliencyDataFilepath = 'PUBLIC_URL/data/twitter-saliency-list-grad-l1.json';
  const atlasDataFilepath = 'PUBLIC_URL/data/twitter-atlas.json';
  const embeddingDataFilepath = 'PUBLIC_URL/data/embedding-list-twitter.json';
  const tableDataFilepath = 'PUBLIC_URL/data/table-list-twitter.json';
